...
public final class Log {
	...
	/**
	 * name of logger for the priority management part.
	 */
	public static final String LOGGER_NAME_PRIORITY = "priority";
	/**
	 * logger object for the priority management part.
	 */
	public static final Logger PRIORITY = LogManager.getLogger(LOGGER_NAME_PRIORITY);
	/**
	 * name of logger for the republishing management part.
	 */
	public static final String LOGGER_NAME_REPUBLISHING = "republishing";
	/**
	 * logger object for the republishing management part.
	 */
	public static final Logger REPUBLISHING = LogManager.getLogger(LOGGER_NAME_REPUBLISHING);
	/**
	 * name of logger for the statistics part (used in JUnit classes).
	 */
	public static final String LOGGER_NAME_STAT = "stat";
	/**
	 * logger object for the statistics part.
	 */
	public static final Logger STAT = LogManager.getLogger(LOGGER_NAME_STAT);
	...
	static {
		...
		setLevel(PRIORITY, Level.WARN);
		setLevel(REPUBLISHING, Level.WARN);
		setLevel(STAT, Level.WARN);
	}
